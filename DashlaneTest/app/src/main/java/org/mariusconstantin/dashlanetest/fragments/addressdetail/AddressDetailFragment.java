 ...
 */
public class AddressDetailFragment extends Fragment implements IAddressDetailContract.IView {
    private AddressDetailFragmentHelper mFragmentHelper = new AddressDetailFragmentHelper();

    public static AddressDetailFragment newInstance(@NonNull IWebsiteModel model) {
        final AddressDetailFragment fragment = new AddressDetailFragment();
